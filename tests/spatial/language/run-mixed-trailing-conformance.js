...
import { generateMixedTrailingCases } from './mixed-trailing-generator.js';
...
export function runMixedTrailingConformance(options = {}) {
  const catalog = options.catalog || FIXTURE_CATALOG;
  const cases = generateMixedTrailingCases({ seed: options.seed ?? 42 });
